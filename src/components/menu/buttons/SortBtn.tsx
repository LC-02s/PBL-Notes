...
export default function SortBtn() {
  ...
  const sortBtnArea = useRef<HTMLDivElement | null>(null);
  const isOutOfClicked = useClickOutOfElement(sortBtnArea);
  ...
  return (
    <SortBtnContainer ref={sortBtnArea}>
      <MenuBtn title='정렬 방식 변경' disabled={isDisabled} onClick={handleBtnClick} onKeyDown={handleBtnKeyDown}>
