...
export default function PinBtn() {
  ...
  const isActive = !isDisabled && memo.data[activeMemo].isPinned;
  const dispatch = useAppDispatch();
  const handleBtnClick = () => { dispatch(toggleMemoPin(activeMemo)); }

  return (
    <MenuToggleBtn $active={isActive} disabled={isDisabled} title={isActive ? '고정 해제' : '메모 고정'} onClick={handleBtnClick}>
      {/* outline */}
